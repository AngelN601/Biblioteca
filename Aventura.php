...
<head>
    ...
    <title>NexusBook - Aventura</title>
...
<body>
    ...
    <main id="main">
        <section id="contact" class="contact mb-5">
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-md-9" data-aos="fade-up">
                    <h3 class="category-title">Genero: Aventura</h3>
                    <div>
                        <form class="d-flex">
		...
		<!-- Aqu� comienza el c�digo PHP para mostrar los libros del g�nero "Horror" -->
                    <?php
                    // Incluir el archivo de conexi�n
                    include 'conexion.php';

                    // Consulta SQL para obtener los datos de la tabla libros filtrados por la categor�a Drama
                    $sql = "SELECT Titulo, Autor, Categoria, Sinopsis FROM Libros WHERE Categoria = 'Aventura'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "No hay libros en la categor�a Aventura";
                    }
