...
<body>
    ...
    <main id="main">
        <section id="contact" class="contact mb-5">
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-md-9" data-aos="fade-up">
                    <h3 class="category-title">Genero: Ficcion</h3>
		      <div>
		...
		<!-- Aqu� comienza el c�digo PHP para mostrar los libros del genero "Horror" -->
		    ...
		    // Obtener la consulta de b�squeda
		    $query = isset($_GET['query']) ? $_GET['query'] : '';

                    // Consulta SQL para obtener los datos de la tabla libros filtrados por la categoria Drama
                    $sql = "SELECT Titulo, Autor, Categoria, Sinopsis FROM Libros WHERE Categoria = 'Ficcion'";
