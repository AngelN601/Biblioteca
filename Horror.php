...
<body>
    ...
    <main id="main">
        <section id="contact" class="contact mb-5">
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-md-9" data-aos="fade-up">
                    <h3 class="category-title">Genero: Horror</h3>
		      <div>
		...
		<!-- Aquï¿½ comienza el cï¿½digo PHP para mostrar los libros del genero "Horror" -->
                    <?php
		    ...
		    $query = isset($_GET['query']) ? $_GET['query'] : '';
                    ...
                    // Consulta SQL para obtener los datos de la tabla libros filtrados por la categorï¿½a Drama
                    $sql = "SELECT Titulo, Autor, Categoria, Sinopsis FROM Libros WHERE Categoria = 'Horror'";
		    ...
		    $result = $conn->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "No hay libros en la categoria Drama";
                    }
